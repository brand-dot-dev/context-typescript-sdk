...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      '{ domain: string; force_language?: string; maxAgeMs?: number; maxSpeed?: boolean; timeoutMS?: number; } | { name: string; country_gl?: string; force_language?: string; maxAgeMs?: number; maxSpeed?: boolean; timeoutMS?: number; } | { email: string; force_language?: string; maxAgeMs?: number; maxSpeed?: boolean; timeoutMS?: number; } | { ticker: string; force_language?: string; maxAgeMs?: number; maxSpeed?: boolean; ticker_exchange?: string; timeoutMS?: number; } | { transaction_info: string; city?: string; country_gl?: string; force_language?: string; high_confidence_only?: boolean; maxSpeed?: boolean; mcc?: number; phone?: number; timeoutMS?: number; };',
    ],
    response:
